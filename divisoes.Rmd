...
Ana Paula Rocha apresenta à Herança as despesas com Água e Saneamento da casa de Paredes de Coura incorridas até à venda da mesma:
...
para um total de **`r agua = sum(agua_coura$Agua, na.rm=T) + sum(agua_coura$Electridade) + sum(agua_coura$NOS, na.rm =T);agua` €**. O balanço após esta transação será: 
...
```{r, include=T}
parcelas = c('inicial','punto','jipe','mudancas','bigbox','funeral','recheio','coura')
