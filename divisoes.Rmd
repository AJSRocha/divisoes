...
Levando esta avaliação em conta, Ana Paula Rocha propõe aos restantes herdeiros a aquisição do Fiat Punto pelo valor de **`r punto = 2000; punto` €**. O balanço após esta transação será de 
...
Alberto Rocha propõe aos restantes herdeiros a aquisição do Mitsubishi Pajero Pinin pelo valor de **`r pinin = 2000; pinin` €**. O balanço após esta transação será de 
...
Imposto Municipal sobre Imóveis da casa da Maia (primeira linha):
![](comprovativos/imi_maia_2022.jpg)

Estas despesas totalizam **`r impostos = 153.85 + 133 + 207.39;impostos`**, € sendo o balanço dos herdeiros após a sua contabilização o seguinte:
...
```{r, include=T}
parcelas = c('inicial','punto','jipe','mudancas','bigbox','funeral','recheio','coura','despesas legais', 'impostos')
